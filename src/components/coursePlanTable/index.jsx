        ...
        <tbody>
          {data.map((course, index) => (
            <tr key={index} className="text-center font-medium text-sm leading-[30px]">
              ...
              <td className="py-3 underline text-custom-1006 border-t border-custom-100"><a href="">{course.lectureMaterial}</a></td>
              <td className="py-3 underline text-custom-1006 border-t border-r border-custom-100"><a href="">{course.lectureVideo}</a></td>
              {course.discourseLink &&
                <td className="py-3 underline text-custom-1006 border-r border-b border-custom-100" rowSpan={2}><a href="">[{course.discourseLink}]</a></td>
              }
